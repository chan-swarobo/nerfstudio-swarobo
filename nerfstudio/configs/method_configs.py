...
from nerfstudio.models.twodgsfacto import TwoDGSfactoModelConfig
...
descriptions = {
    ...
    "twodgsfacto": "2D Gaussian Splatting model",
...
twodgsfacto_config = TrainerConfig(
    method_name="twodgsfacto",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
...
method_configs["twodgsfacto"] = twodgsfacto_config
